...
print(f"INFERENCE_API_KEY: {os.getenv('INFERENCE_API_KEY')}")
...
def read_pdf_data_from_folder(folder_path):
    text = ""
...
# Create vectorstore
def create_vectorstore_from_folder(folder_path):
    raw_text = read_pdf_data_from_folder(folder_path)  # Get PDF text from the folder
